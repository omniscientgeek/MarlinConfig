...
#define STRING_CONFIG_H_AUTHOR "(Justin Pettinger, CR-10 V3)" // Who made the changes.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 48, 48, 29, 42 }  // (mm) Left, Front, Right, Back insets
